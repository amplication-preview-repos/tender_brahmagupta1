...
export class EventResolverBase {
  ...
  @graphql.Query(() => AboutUsContent)
  async AboutUsContent(
    @graphql.Args()
    args: string
  ): Promise<AboutUsContent> {
    return this.service.AboutUsContent(args);
  }
  ...
  async GetAboutUs(
    ...
    return this.service.GetAboutUs(args);
  }
  ...
  async GetHomepage(
    ...
    return this.service.GetHomepage(args);
  }

  @graphql.Query(() => HomepageContent)
  async HomepageContent(
    @graphql.Args()
    args: string
  ): Promise<HomepageContent> {
    return this.service.HomepageContent(args);
  }
}
