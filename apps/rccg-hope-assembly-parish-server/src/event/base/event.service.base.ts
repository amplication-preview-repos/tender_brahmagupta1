...
export class EventServiceBase {
  ...
  async AboutUsContent(args: string): Promise<AboutUsContent> {
    throw new Error("Not implemented");
  }
  async GetAboutUs(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async GetHomepage(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async HomepageContent(args: string): Promise<HomepageContent> {
    throw new Error("Not implemented");
  }
}
